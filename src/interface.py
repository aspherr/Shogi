...
class Interface:
    def __init__(self) -> None:
        ...
        self.buttons = [
            Button(
                BUTTON[0], BUTTON[1], (290, 65), (300, 236), (295, 220), 37, "large"
            ),
            Button(
                BUTTON[2], BUTTON[3], (290, 65), (300, 347), (295, 330), 37, "large"
            ),
            Button(
                BUTTON[4], BUTTON[5], (290, 65), (300, 457), (295, 440), 37, "large"
            ),
            Button(
                BUTTON[6], BUTTON[7], (215, 65), (338, 567), (294, 550), 37, "large"
            ),
            Button(
                BUTTON[8], BUTTON[9], (130, 40), (740, 622), (715, 612), 35, "small"
            ),
        ]
...
class Pregame:
    def __init__(self) -> None:
        ...
        self.buttons = [
            ...
            Button(
                BUTTON[10], BUTTON[11], (290, 82), (300, 275), (295, 220), 37, "large"
            ),
            Button(
                BUTTON[12], BUTTON[13], (290, 82), (300, 405), (295, 350), 37, "large"
            ),
            Button(
                BUTTON[14], BUTTON[15], (290, 82), (300, 275), (295, 220), 37, "large"
            ),
            Button(
                BUTTON[16], BUTTON[17], (290, 82), (300, 405), (295, 350), 37, "large"
            ),
        ]
...
class Game:
    ...
    def calc_pos(self, mx, my, dimensions, type) -> tuple:
        if type == "board":
            mx -= dimensions[0]
            my -= dimensions[1]
    ...
    def get_mouse_pos(self, pos) -> tuple:
        ...
        if (
            BOARD_SIZE[0] < x < BOARD_SIZE[0] + BOARD_SIZE[2]
    ...
    def input(self, event):
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if (
                BOARD_SIZE[0] < mx < BOARD_SIZE[0] + BOARD_SIZE[2]
                and BOARD_SIZE[1] < my < BOARD_SIZE[1] + BOARD_SIZE[3]
            ):
...
class Options:
    def __init__(self) -> None:
        ...
        self.buttons = [
            Button(POINTER[3], POINTER[4], (55, 55), (30, 610), (30, 610), 0, "none"),
            Button(
                BUTTON[18], BUTTON[19], (300, 300), (110, 200), (110, 200), 0, "none"
            ),
            Button(
                BUTTON[20], BUTTON[21], (300, 300), (490, 200), (490, 200), 0, "none"
            ),
        ]
...
class Credits:
    def __init__(self) -> None:
        ...
        self.button = Button(
            POINTER[3], POINTER[4], (55, 55), (30, 610), (30, 610), 0, "none"
        )
    ...
    def input(self, event, max_index):
        if self.draw_next:
            ...
            if (
                ...
                and self.buttons[0].clicked
                and self.index != max_index
            ):
                UI_CLICK_SFX.play()
                self.index += 1
