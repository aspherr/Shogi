...
UI_CLICK_SFX = pygame.mixer.Sound(
    os.path.join("assets", "sfx", "002-navigation-click.wav")
)
...
BG_SPRITES = ["001-home-bg", "002-default-bg"]
BACKGROUND = [
    pygame.image.load(os.path.join("assets", "sprites", "menu", "home", f"{img}.png"))
...
BOARD_SPRITE = pygame.image.load(
    os.path.join("assets", "sprites", "board", "001-board.png")
)
KOMA1_SPRITE = pygame.image.load(
    os.path.join("assets", "sprites", "komadai", "003-01-koma.png")
)
KOMA2_SPRITE = pygame.image.load(
    os.path.join("assets", "sprites", "komadai", "004-02-koma.png")
)
